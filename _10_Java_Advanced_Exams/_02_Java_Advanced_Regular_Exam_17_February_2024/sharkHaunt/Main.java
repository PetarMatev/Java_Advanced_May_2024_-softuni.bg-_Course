...
public class Main {
    public static void main(String[] args) {
        ...
        //Remove Shark
        System.out.println(pacific.removeShark("Carpet shark"));
        //false

        System.out.println(atlantic.removeShark("Lemon shark"));
        //false
        System.out.println(atlantic.removeShark("Bull shark"));
        //true

        //Get the largest shark
        System.out.println(pacific.getLargestShark().getKind());
        //Whale shark

        //Get the average length of sharks in given basin
        System.out.println(pacific.getAverageLength());
        //506

        System.out.println(atlantic.getCount());
        //0
